// ===============================================================================
//  GENERATED BY CTRE PHOENIX TUNER X -- DO NOT HAND-EDIT
//
//  This file is a PLACEHOLDER carried over from a previous robot. The gear
//  ratios, wheel radius, CAN IDs, steer offsets, and slip current below describe
//  hardware that is probably not the hardware you have.
//
//  Before the drivetrain will move correctly:
//    1. Open Phoenix Tuner X and run the Swerve Project Generator
//    2. Overwrite this file with what it produces
//    3. Check that the CAN IDs match RobotMap.canIDs.Drivetrain
//
//  Anything you hand-edit here is lost the next time it is regenerated, so put
//  drivetrain customizations in CommandSwerveDrivetrain instead.
// ===============================================================================
...
public class TunerConstants {
    ...
    // -- ALTERNATIVE NUMBERS WE ARE PLAYING WITH --
    // private static final Slot0Configs steerGains = new Slot0Configs()
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.383056640625);
